...
[CONFLICT — 26 September 2026] The progression model in [docs/design/CLASS_PROGRESSION_GROWTH_AND_TASK.md](docs/design/CLASS_PROGRESSION_GROWTH_AND_TASK.md) makes infrastructure timing **class-authored** rather than universal: Mole receives Route access at Lv18, while Gardener may spend Growth budget on Development Zone Capacity as early as Lv6. Under that model Level 6 is at most a common case, not the breakpoint. The two statements are recorded together; the owner decides whether Level 6 survives as a floor, a default, or nothing.
