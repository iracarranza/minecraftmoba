...
On upgrade, missing bundled config keys are merged and saved while explicit values
are preserved; this includes registry sections introduced after the initial scaffold.
